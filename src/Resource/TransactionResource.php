...
final class TransactionResource extends AbstractResource
{
     ...
     *
     * @param ListTransactionsRequest|null $request Optional request with filter criteria
     * @return ListTransactionsResponse Response with list of transactions
     */
    public function list(?ListTransactionsRequest $request = null): ListTransactionsResponse
    {
        return $this->executeTyped($request ?? new ListTransactionsRequest(), ListTransactionsResponse::class);
    }
