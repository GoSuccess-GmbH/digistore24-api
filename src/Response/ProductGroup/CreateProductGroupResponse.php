...
final readonly class CreateProductGroupResponse extends AbstractResponse
{
    ...
    public function getProductGroupId(): ?string { return $this->data['product_group_id'] ?? null; }
