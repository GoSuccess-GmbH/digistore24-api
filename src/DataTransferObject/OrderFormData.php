...
final class OrderFormData
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $instance->layout = $data['layout'] ?? null;
        $instance->backgroundStyle = $data['background_style'] ?? null;
        $instance->stepCount = isset($data['step_count']) ? (int) $data['step_count'] : null;
        $instance->shippingPosition = $data['shipping_position'] ?? null;
        $instance->summaryPositions = $data['summary_positions'] ?? null;
        $instance->flexElementsOrder = $data['flex_elements_order'] ?? null;
        $instance->tabStyle = $data['tab_style'] ?? null;
        $instance->tabText1Hl = $data['tab_text_1_hl'] ?? null;
        $instance->tabText1Sl = $data['tab_text_1_sl'] ?? null;
        $instance->tabText2Hl = $data['tab_text_2_hl'] ?? null;
        $instance->tabText2Sl = $data['tab_text_2_sl'] ?? null;
        $instance->tabText3Hl = $data['tab_text_3_hl'] ?? null;
        $instance->tabText3Sl = $data['tab_text_3_sl'] ?? null;
        $instance->tabImage1Id = $data['tab_image_1_id'] ?? null;
        $instance->tabImage2Id = $data['tab_image_2_id'] ?? null;
        $instance->tabImage3Id = $data['tab_image_3_id'] ?? null;
        $instance->tabImage1Url = $data['tab_image_1_url'] ?? null;
        $instance->tabImage2Url = $data['tab_image_2_url'] ?? null;
        $instance->tabImage3Url = $data['tab_image_3_url'] ?? null;
        $instance->orderBumpStyle = $data['order_bump_style'] ?? null;
        $instance->orderbumpProductId = $data['orderbump_product_id'] ?? null;
        $instance->orderbumpHeadline = $data['orderbump_headline'] ?? null;
        $instance->orderbumpHtml = $data['orderbump_html'] ?? null;
        $instance->orderbumpPosition = $data['orderbump_position'] ?? null;
        $instance->refundWaiverPosition = $data['refund_waiver_position'] ?? null;
        $instance->customCss = $data['custom_css'] ?? null;
    ...
    public function toArray(): array
    {
        ...
        if ($this->backgroundStyle !== null) $data['background_style'] = $this->backgroundStyle;
        if ($this->stepCount !== null) $data['step_count'] = $this->stepCount;
        if ($this->shippingPosition !== null) $data['shipping_position'] = $this->shippingPosition;
        if ($this->summaryPositions !== null) $data['summary_positions'] = $this->summaryPositions;
        if ($this->flexElementsOrder !== null) $data['flex_elements_order'] = $this->flexElementsOrder;
        if ($this->tabStyle !== null) $data['tab_style'] = $this->tabStyle;
        if ($this->tabText1Hl !== null) $data['tab_text_1_hl'] = $this->tabText1Hl;
        if ($this->tabText1Sl !== null) $data['tab_text_1_sl'] = $this->tabText1Sl;
        if ($this->tabText2Hl !== null) $data['tab_text_2_hl'] = $this->tabText2Hl;
        if ($this->tabText2Sl !== null) $data['tab_text_2_sl'] = $this->tabText2Sl;
        if ($this->tabText3Hl !== null) $data['tab_text_3_hl'] = $this->tabText3Hl;
        if ($this->tabText3Sl !== null) $data['tab_text_3_sl'] = $this->tabText3Sl;
        if ($this->tabImage1Id !== null) $data['tab_image_1_id'] = $this->tabImage1Id;
        if ($this->tabImage2Id !== null) $data['tab_image_2_id'] = $this->tabImage2Id;
        if ($this->tabImage3Id !== null) $data['tab_image_3_id'] = $this->tabImage3Id;
        if ($this->tabImage1Url !== null) $data['tab_image_1_url'] = $this->tabImage1Url;
        if ($this->tabImage2Url !== null) $data['tab_image_2_url'] = $this->tabImage2Url;
        if ($this->tabImage3Url !== null) $data['tab_image_3_url'] = $this->tabImage3Url;
        if ($this->orderBumpStyle !== null) $data['order_bump_style'] = $this->orderBumpStyle;
        if ($this->orderbumpProductId !== null) $data['orderbump_product_id'] = $this->orderbumpProductId;
        if ($this->orderbumpHeadline !== null) $data['orderbump_headline'] = $this->orderbumpHeadline;
        if ($this->orderbumpHtml !== null) $data['orderbump_html'] = $this->orderbumpHtml;
        if ($this->orderbumpPosition !== null) $data['orderbump_position'] = $this->orderbumpPosition;
        if ($this->refundWaiverPosition !== null) $data['refund_waiver_position'] = $this->refundWaiverPosition;
        if ($this->customCss !== null) $data['custom_css'] = $this->customCss;
